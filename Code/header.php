            ...
            <ul>
                ...
                <li class="dropdown"><a href="/digitial-portfolio.php" class="dropbtn" <?php if (isset($thisPage) && $thisPage=="digitial-portfolio"){
                    ...
                    <div class="dropdown-content">
                        <a href="..\Pages\MTF_documentation.php" class="dropdown-links"<?php if (isset($thisPage) && $thisPage=="MTF_tool"){
                            echo " id=\"current-page\"";
                            }?>>MTF Tool</a>
                        <a href="..\Pages\Color-checker.php" class="dropdown-links"<?php if (isset($thisPage) && $thisPage=="Color_Analysis"){
                            echo " id=\"current-page\"";
                            }?>>Color Analysis</a>
                        <a href="..\Pages\Curtis_projects.php" class="dropdown-links"<?php if (isset($thisPage) && $thisPage=="PDO_and_Solenoid"){
                            echo " id=\"current-page\"";
                            }?>>PDO and Solenoids</a>
                    </div>
                </a></li>
